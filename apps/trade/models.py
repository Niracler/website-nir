...
class ShoppingCart(models.Model):
    """购物车"""
    user = models.ForeignKey(User, on_delete=models.DO_NOTHING, verbose_name=u"用户")
    goods = models.ForeignKey(Goods, on_delete=models.DO_NOTHING, verbose_name=u"商品")
...
class OrderInfo(models.Model):
    ...
    pay_time = models.DateTimeField(null=False, blank=True, verbose_name="支付时间")
